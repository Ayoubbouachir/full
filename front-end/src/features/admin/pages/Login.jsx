                        ...
                        <div className="form-login">
                            ...
                            <div className="checkbox-login">
                                <div className="remember">
                                    ...
                                    <p className="remember-pass">Remember my preference</p>
                                </div>
                                <p className="Forget"><a href="forgetPassword.html">Forget Password?</a></p>
                            </div>
                            <a href="/" className="buttons-link account-create-btn">Sign In</a>
                            <p className="Already">Not registered? <a href="registre">Register Now</a></p>
                        </div>
                    </div>
                </div>
            </div>
