		...
		const fetchData = async () => {
			try {
				const [projectsRes, usersRes] = await Promise.all([
					fetch('http://localhost:3100/projects/FindAll').then(res => res.json()),
			...
			<section className="banner-section bg-1">
				<div className="container">
					<div className="banner-content">
						<h1 className="wow fadeInUp delay-0-2s">Constructing Excellence for Every Project.</h1>
						<p className="wow fadeInUp delay-0-4s">Building your vision with precision, quality, and innovative AI-driven project management.</p>
								...
								<div key={member._id} className="col-lg-4 col-md-6">
									<div className="main-team-item fadeInUp delay-0-2s">
										<Link to={`/teamDetail?id=${member._id}`} className="team-img">
											<img src={member.imageUrl || "/assets/images/team/team-1.jpg"} alt={member.prenom} />
										</Link>
